...
public class TemplateCacheTest {
    ...
    public void testCreateFileResult() throws Exception {
        ...
        final Path functionFile = IO.toPath(TemplateCacheTest.class.getResource("functions.xsl").toURI());
    ...
    public void testFallback() throws Exception {
        ...
        final Path file0 = IO.toPath(TemplateCacheTest.class.getResource("template-cache-test/formatter/file0.txt").toURI());
        final Path file1 = IO.toPath(TemplateCacheTest.class.getResource("template-cache-test/schema1/formatter/file1.txt").toURI());
        final Path file2 = IO.toPath(TemplateCacheTest.class.getResource("template-cache-test/schema2/formatter/file2.txt").toURI());
        final Path file3 = IO.toPath(TemplateCacheTest.class.getResource("template-cache-test/file3.txt").toURI());
