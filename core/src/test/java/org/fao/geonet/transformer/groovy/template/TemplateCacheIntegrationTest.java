...
public class TemplateCacheIntegrationTest extends AbstractCoreIntegrationTest{
    ...
    public void testOnlineResource() throws Exception {
        ...
        Path rootFormatterDir = schemaDir.resolve(TransformerConstants.SCHEMA_PLUGIN_FORMATTER_DIR);
        Path formatterDir = Paths.get(TemplateCacheIntegrationTest.class.getResource("template-cache-test").toURI());
