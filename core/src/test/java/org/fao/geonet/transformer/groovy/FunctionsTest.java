...
public class FunctionsTest {
    ...
    private TransformerParams fparams;
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(appContext.getBean(TransformerResources.class)).thenReturn(new TransformerResources());

        fparams = new TransformerParams() {
            @Override
        ...
        appContext.getBean(TransformerResources.class).setIsoLanguagesMapper(languagesMapper);
        appContext.getBean(TransformerResources.class).setSystemInfo(SystemInfo.createForTesting(SystemInfo.STAGE_TESTING));
    ...
    public void testGetXPath() throws Exception {
        ...
        final GPathResult xml = AbstractCoreIntegrationTest.parseXml(sampleMetadataXml);
