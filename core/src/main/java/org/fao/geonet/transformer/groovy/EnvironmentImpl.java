...
public class EnvironmentImpl implements Environment {
    ...
    public EnvironmentImpl(TransformerParams fparams, IsoLanguagesMapper mapper) {
    ...
    public MapConfig getMapConfiguration() {
        ...
        final String background = settingManager.getValue(SettingManager.REGION_GETMAP_BACKGROUND);
        final String mapproj = settingManager.getValue(SettingManager.REGION_GETMAP_MAPPROJ);
        final Integer width = settingManager.getValueAsInt(SettingManager.REGION_GETMAP_WIDTH);
        final Integer thumbnailWidth = settingManager.getValueAsInt(SettingManager.REGION_GETMAP_SUMMARY_WIDTH);
