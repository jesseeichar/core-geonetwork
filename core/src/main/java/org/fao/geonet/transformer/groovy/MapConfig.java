...
/**
 * Encapsulates the map parameters used when making org.fao.geonet.services.region.GetMap requests.
 *
...
public class MapConfig {
    ...
    /**
     * The value to pass as the <em>background</em> parameter when making a request to org.fao.geonet.services.region.GetMap
     * when rendering extents and geometries.
     */
    public String getBackground() {
        return background.toLowerCase().startsWith("http://") ? SettingManager.REGION_GETMAP_SETTING_BACKGROUND: background;
    }
