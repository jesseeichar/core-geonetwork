...
import org.fao.geonet.transformer.groovy.CurrentLanguageHolder;
...
public class SchemaLocalizations {
    ...
    protected ConfigFile getConfigFile(SchemaManager schemaManager, String schema) throws IOException {
        final Path schemaDir = schemaManager.getSchemaDir(schema).resolve(TransformerConstants.SCHEMA_PLUGIN_FORMATTER_DIR);
     ...
     */
    public static Map<String, SchemaLocalization> loadSchemaLocalizations(ApplicationContext context, SchemaManager schemaManager)
