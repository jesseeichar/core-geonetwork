(function() {
  ...
  goog.require('gn_metadataformatter_controller');
  goog.require('gn_metadataformatterfunction_controller');

  var module = angular.module('gn_adminmetadata_controller',
    ['gn_metadataformatter_controller',
      'gn_metadataformatterfunction_controller',
...
//              href: '#/metadata/schematron'
      ...
      $scope.formatterPage = 'formatters';
      $scope.schemas = [];
